 ...
 * @Author chenyuxiang
 * @Date 2026-06-08
 * @Description 给你一个下标从 0 开始的整数数组 nums 和一个整数 pivot 。请你将 nums 重新排列，使得以下条件均成立：
...
public class Solution {
    ...
    private int[] combine(List<Integer> less, List<Integer> equal, List<Integer> greater) {
